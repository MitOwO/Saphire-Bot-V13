...
• ~`-delete all`~ Comandos riscados indenficam **reforma/manutenção**. Portanto, estarão fora do ar.
...
`-bug [Descrição do ocorrido]` Envie bugs/erros que você notou direto pro Rody#1458, o criador da Saphire
...
# 📝 Quiz - BETA
• O Saphire Quiz é um jogo simples e divertido de brincar. Tendo 2 modos, é possivel brincar bastante. Jogar com os amigos é ainda mais divertido!!!
