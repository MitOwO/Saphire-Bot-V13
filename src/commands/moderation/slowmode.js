...
module.exports = {
    ...
    run: async (client, message, args, prefix, db, MessageEmbed, request) => {
        ...
        const noargs = new MessageEmbed().setColor('BLUE')
            ...
            .addFields(
                {
                    name: `${e.On} Ative o Slowmode`,
                    value: `\`${prefix}slowmode 10s/20s...\`\nMax: 21600 (6hrs)`, inline: true
                },
                {
                    name: `${e.Off} Desative o Slowmode`,
                    value: `\`${prefix}slowmode 0/off`, inline: true
                }
            )
