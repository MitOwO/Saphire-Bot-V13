...
module.exports = {
    ...
    run: async (client, message, args, prefix, db, MessageEmbed, request) => {
        ...
        return message.channel.send(`${e.Loading} | ${user}, você está sendo desafiado para um duelo.\nDesafiante: ${message.author}\nValor: ${Valor} ${Moeda(message)}`).then(msg => {
            ...
            const CollectorCancel = msg.createReactionCollector({ FilterCancel, time: 30000 });
            ...
            function DuelStart() {
                db.set(`${message.author.id}.Duelo`, true); db.set(`${user.id}.Duelo`, true)
                ...
                setTimeout(() => {
                    ...
                    db.delete(`${message.author.id}.DuelInit`)
                }, 4000)
            }
